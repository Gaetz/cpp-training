...
void State_Intro::onCreate()
{
    ...
    // Sprite
    mIntroTexture.loadFromFile("img/intro.png");
    ...
    evMgr->addCallback(StateType::Intro, "intro_carryOn", &State_Intro::carryOn, this);
}

void State_Intro::onDestroy()
{
    EventManager *evMgr = mStateManager->getContext()->mEventManager;
    evMgr->removeCallback(StateType::Intro, "intro_carryOn");
}
